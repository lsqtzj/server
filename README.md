MaNGOS Four [![Build Status](https://travis-ci.org/mangosfour/server.png)](https://travis-ci.org/mangosone/server)
===========
*MaNGOS Four* is a full featured server for [World of Warcraft][2], in its Mists of Pandaria
version supporting clients from the [patch 5.1.0][50] branch, specifically patch
5.1.0.
...
[50]: http://www.wowpedia.org/Patch_5.1.0 "WoW MOP · Patch 5.1.0 release notes"
